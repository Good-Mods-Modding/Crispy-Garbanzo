...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> CRISPY_GARBANZO = CREATIVE_MODE_TAB.register("crispy_garbanzo", () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.TUNGSTEN_INGOT.get())).title(Component.translatable("itemGroup.crispygarbanzo")).displayItems((itemDisplayParameters, output) -> {
